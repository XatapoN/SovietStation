		...
		switch(rank)
			...
			if("Chef")
				for(var/obj/structure/noticeboard/assistant_nb/nBoard in world)
					var/obj/item/weapon/paper/P = new /obj/item/weapon/paper(nBoard.loc)
					P.name = "Су-шеф"
					P.info = "<b>\t ТребуетсЯ помощник повара. По данному вопросу обращайтесь к повару.</b>"
					P.update_icon()
					P.updateinfolinks()
					P.loc = nBoard
					nBoard.notices++
			...
			if("Cargo Technician")
				for(var/obj/structure/noticeboard/assistant_nb/nBoard in world)
					var/obj/item/weapon/paper/P = new /obj/item/weapon/paper(nBoard.loc)
					P.name = "Почтальон"
					P.info = "<b>\t В отдел поставок требуетсЯ почтальон. По данному вопросу обращайтесь к квартирмейстру или грузчикам.</b>"
					P.update_icon()
					P.updateinfolinks()
					P.loc = nBoard
					nBoard.notices++
			...
			if("Security Officer")
				for(var/obj/structure/noticeboard/assistant_nb/nBoard in world)
					var/obj/item/weapon/paper/P = new /obj/item/weapon/paper(nBoard.loc)
					P.name = "Уборщик в бриг"
					P.info = "<b>\t В бриг требуетсЯ уборщик. По данному вопросу обращайтесь к вардену или офицерам.</b>"
					P.update_icon()
					P.updateinfolinks()
					P.loc = nBoard
					nBoard.notices++
			...
			if("Detective")
				for(var/obj/structure/noticeboard/assistant_nb/nBoard in world)
					var/obj/item/weapon/paper/P = new /obj/item/weapon/paper(nBoard.loc)
					P.name = "Помощник детектива"
					P.info = "<b>\t ТребуетсЯ помощник детектива. По данному вопросу обращайтесь к детективу.</b>"
					P.update_icon()
					P.updateinfolinks()
					P.loc = nBoard
					nBoard.notices++
			...
			if("Bartender")
				for(var/obj/structure/noticeboard/assistant_nb/nBoard in world)
					var/obj/item/weapon/paper/P = new /obj/item/weapon/paper(nBoard.loc)
					P.name = "Официант"
					P.info = "<b>\t ТребуетсЯ официант в бар. По данному вопросу обращайтесь к бармену.</b>"
					P.update_icon()
					P.updateinfolinks()
					P.loc = nBoard
					nBoard.notices++
