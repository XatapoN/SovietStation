...
/obj/machinery/smartfridge/chem
	name = "\improper Pharmaceutic Storage"
	desc = "A refrigerated storage unit for medicaments."

/obj/machinery/smartfridge/chem/accept_check(var/obj/item/O as obj)
	if(istype(O,/obj/item/weapon/reagent_containers/glass/bottle))
		return 1
...
/obj/machinery/smartfridge/blood/New()
	contents += new/obj/item/weapon/reagent_containers/blood/APlus
	contents += new/obj/item/weapon/reagent_containers/blood/APlus
	contents += new/obj/item/weapon/reagent_containers/blood/AMinus
	contents += new/obj/item/weapon/reagent_containers/blood/AMinus
	contents += new/obj/item/weapon/reagent_containers/blood/BPlus
	contents += new/obj/item/weapon/reagent_containers/blood/BPlus
	contents += new/obj/item/weapon/reagent_containers/blood/BMinus
	contents += new/obj/item/weapon/reagent_containers/blood/BMinus
	contents += new/obj/item/weapon/reagent_containers/blood/OPlus
	contents += new/obj/item/weapon/reagent_containers/blood/OPlus
	contents += new/obj/item/weapon/reagent_containers/blood/OMinus
	contents += new/obj/item/weapon/reagent_containers/blood/empty
	contents += new/obj/item/weapon/reagent_containers/blood/empty
	contents += new/obj/item/weapon/reagent_containers/blood/empty
	contents += new/obj/item/weapon/reagent_containers/blood/empty
	item_quants += list("BloodPack A(II)RH-positive" = 2, "BloodPack A(II)RH-negative" = 2, "BloodPack B(III)RH-positive" = 2, "BloodPack B(III)RH-negative" = 2, "BloodPack O(I)RH-positive" = 2, "BloodPack O(I)RH-negative" = 1, "Empty BloodPack" = 4)
